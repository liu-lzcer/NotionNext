  ...
  return (
    ...
    >
      <div
        ...
        } shadow transition-all duration-200 today-card h-full bg-[] rounded-xl relative overflow-hidden flex items-end`}
      >
        <div
          id="today-card-info"
        ...
        <div
          ...
          style={{
            background: `url('https://cloud.faebange.top/file/c75fe133c6109bce2c7ea.png') no-repeat center /cover`
          }}
        ></div>
      </div>
    </div>
